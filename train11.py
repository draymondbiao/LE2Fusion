...
from test_all.ei import con2
from test_cls_model import Illumination_classifier
from models.common import gradient, clamp, gradient_lp, YCrCb2RGB
from models.fusion_new import PIAFusion
...
################################数据处理
                ...
                ei_ir = con2(inf_image)
                ei_vi = con2(vis_y_image)
                ei_ir = ei_ir/9
                ei_vi = ei_vi / 9
