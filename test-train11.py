...
from fusion_new import LE2Fusion

# device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
from test_cls_model import Illumination_classifier
import torch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', metavar='DIR', default='/data/Disk_A/yongbiao/USERPROG/PIAFusion/test_data/MSRS-main',
    ...
    parser.add_argument('--vi_weight_save_path', default='result_train-20/PIAFusion208_RoadScene/weight_vi')# 融合结果权重图存放位置
    parser.add_argument('--ir_weight_save_path', default='result_train-20/PIAFusion208_RoadScene/weight_ir')
